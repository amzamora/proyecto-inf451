...
OBJS = main.o shader.o graphics.o game.o utilities.o glad.o cube.o quad.o imgui.o imgui_draw.o imgui_tables.o imgui_widgets.o imgui_demo.o imgui_impl_opengl3.o imgui_impl_glfw.o
